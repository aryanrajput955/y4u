				...
				<section className='mb-16'>
					...
					<ul className='space-y-3 text-gray-700'>
						<li className='flex items-start gap-3'>
							<span className='font-semibold text-blue-600 min-w-2'>•</span>
							<span>
						...
						<li className='flex items-start gap-3'>
							...
							<span>
								...
								"We", "Us" or "Our" in this Agreement) refers to Y4U ULTIMATE
								INDUSTRIAL SKILL TRAINING SOLUTIONS PVT LTD, 184, Subhash Nagar,
						...
						<li className='flex items-start gap-3'>
							<span className='font-semibold text-blue-600 min-w-2'>•</span>
							<span>
								<strong>Website</strong> refers to Y4U ULTIMATE INDUSTRIAL SKILL
								TRAINING SOLUTIONS PVT LTD, accessible from{' '}
								<Link
									href='https://www.y4uultimate.com/'
									className='text-blue-700 hover:underline'>
									https://www.y4uultimate.com/
								</Link>
							</span>
						</li>
						<li className='flex items-start gap-3'>
					...
					<ul className='space-y-2 text-gray-700'>
						<li className='flex items-start gap-3'>
							...
							<span>
								By email:{' '}
								<Link
									href='mailto:yogeshggangwar@gmail.com'
									className='text-blue-700 hover:underline'>
						...
						<li className='flex items-start gap-3'>
							...
							<span>
								...
								<Link
									href='https://y4uultimate.com/'
									className='text-blue-700 hover:underline'>
									https://y4uultimate.com/
								</Link>{' '}
