  ...
  return (
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative rounded-3xl bg-gradient-to-br from-blue-50 via-white to-blue-100 border border-blue-200 p-12 md:p-16 text-center shadow-sm">
          ...
          <p className="text-gray-600 text-lg max-w-2xl mx-auto mb-10">
            Join thousands of students who started their careers through Y4U’s industry-backed
            training programs—100% practical & affordable.
          </p>
