			...
			<div className='max-w-7xl mx-auto px-6'>
				<div className='text-center mb-16'>
					...
					<p className='text-gray-600 max-w-2xl mx-auto mt-4'>
						Practical training, experienced mentors, and multi-industry
						programs.
					</p>
				</div>
				...
				<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
					{features.map((f, i) => (
						<div
							key={i}
							className='group p-8 rounded-2xl bg-white border border-blue-200 hover:border-blue-400 transition shadow-sm'>
							<div
